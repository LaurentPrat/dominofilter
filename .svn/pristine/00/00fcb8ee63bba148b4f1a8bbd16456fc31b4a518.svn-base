 ...
 *********************************************************************/
#ifdef V4
#define NOMAPI "MWADVT4 3.93.47"
#else
#define NOMAPI "MWADVT 3.93.47"
#endif
...
#define	SKIPEXTENSIONMGR				"NOT_EM"				/* Special field in ADVSRV */
...
struct advt_stat
{
	...
	char	Time[6];											/* Heure serveur du traitement */
	char	PostedDate[11];										/* Date d'emission du message */
	char	PostedTime[6];										/* Heure d'emission du message */
	...
	char	Ext[150];											/* Extensions des fichiers rattachés (ext1, ext2, ...) */
	BOOL	Sign;
	BOOL	Crypt;
