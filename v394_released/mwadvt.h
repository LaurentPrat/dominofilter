...
#ifdef V4
#define API_VERSION		"(4). 4.1.1.130"
#else
#define API_VERSION		"4.1.1.130"
#endif
...
#define MW_KEEP_MSG_HOLD				"MW_HOLD"					/* Do not release HOLD state.. blocking errors */
#define MW_HAS_ATTACHMENT_MAKER			"MW_HAS_ATTACHMENT"			/* string : "" or "1" */
...
#define MAIL_ORIGDOCLINK_DBID			"MWORIGDOCLINKREPID"		/* string : DOCID */
...
#define BLACKLIST_TIME_SLOT_DAYHOURS	"BL_TimeSlot"				/* Backlist doc : timeslot : DDHH,DDHH,...,DDHH  -char(1024) : 7*24*4 */
...
#define MAILNOTE_BLINDCOPY_FIELD		"BlindCopyTo"				/* mail field 							*/
#define MAILNOTE_JOURNAL_EXPAND_REC		"$JournalRecipientsExpanded_"
#define MAILNOTE_JOURNAL_REC			"$JournalRecipients"
...
#define BLIST_MAILCOPY_MAILIN			"MailCopy_MailIn"		/* 3.94.71 */
...
#define MW_MACRO_FIELD_RECIPIENTS		"MW_RECIPIENTS"			/* TEXT list : 4.1.0.102 */
...
#define DO_INIT_OPEN_DB					"Doing initialization - App Db Opened"
#define DO_INIT_OPEN_DB_NAMES			"Doing initialization - Names.nsf Opened"
#define DO_INIT_LOADING_RULES			"Doing initialization - Loading rules definition"
#define DO_INIT_LOADING_RULES_MEM		"Doing initialization - Loading rules memory file"
#define DO_INIT_LOADING_RULES_MEM_LOAD	"Doing initialization - Rules memory file loaded OK"
#define DO_INIT_RULES_LOADED			"Doing initialization - Rules definition loaded OK"
#define INIT_DONE						"%s : initialization ended"

#define ETAT_WAIT					API_VERSION " Idle Task"
#define ETAT_ACTIVE					"Processing message(s)"
#define API_BLIST_OTHER_REC_FIELD	"%s : Filtering configured to use '%s' for recipient field"
#define API_BLIST_KEEP_ORIG_REC_FIELD	"%s : Filtering configured to override 'alternate recipient' but use the original recipient for routing"
...
#define ERR_READ_GROUP				"%s : Error while reading the group '%s' in the database '%s'"
...
#define ERR_ATTACH_NOT_FOUND		"%s : Error while searching for attachment for document 'NT%08lX' in the database '%s'"
...
#define ERR_JOURNAL_FAILURE_REASON  "Filtered Compliance Journaling attempt failed, Pending for retry"
#define ERR_CREATE_JOURNAL_DOC		"%s : Error creating a new safe copy for journaling in the database '%s'"
#define ERR_SAVE_JOURNAL_DOC		"%s : Error saving copy for journaling in the database '%s'"					/* 4.0.1.107 */
